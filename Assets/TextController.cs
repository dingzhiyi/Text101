...
public class TextController : MonoBehaviour
{
    ...
    void state_sheets_0()
    {
        text.text = "You cannot believe you sleep in these things. Surely it's " +
    ...
    void state_lock_0()
    {
        text.text = "This is one of those button locks. You have no idea what " +
            "The combination is. You wish you could somehow see where the " +
    ...
    void state_lock_1()
    {
        text.text = "You carefully put the mirror through the bars, and turn it round "+
            "so you can see the lock. You can just make out fingerprints "+
            "around the buttons. You press the dirty buttons, and hear a click.\n\n"+
    ...
    {
        text.text = "You are in a corridor right now\n\n" +
